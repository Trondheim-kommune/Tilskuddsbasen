...
app.config.update(
    ...
    SESSION_COOKIE_NAME="flod_tilskudd_session",
    REMEMBER_COOKIE_NAME="flod_tilskudd_remember_token"
)
...
roles = {
    'adfs': {
        u'Administrator': u'tilskudd_administrator',
        u'Godkjenner': u'tilskudd_godkjenner',
        u'Saksbehandler': u'tilskudd_saksbehandler'
    },
...
class AuthUser(UserMixin):
    ...
    def is_soker(self):
        return self.is_idporten_user()

    def is_saksbehandler(self):
        return self.is_adfs_user() and self.has_role("tilskudd_saksbehandler")

    def is_godkjenner(self):
        return self.is_adfs_user() and self.has_role("tilskudd_godkjenner")

    def is_administrator(self):
        return self.is_adfs_user() and self.has_role("tilskudd_administrator")
