...
(function (ns) {
    ...
    var setup = function (templatePath) {
        ...
        TestSoknadModel = ns.SoknadModel.extend({
            ...
            initialize: function () {
                var vedtak = [
                    {'id': 1, 'vedtaksdato': "2014-01-12", 'vedtatt_belop': 230},
        ...
        TestVurderKlageActionView = ns.VurderKlageActionView.extend({
            initialize: function (options) {
                this.soknadModel = options.soknadModel;
    ...
    buster.testCase("VurderKlageActionViewTest", {

        setUp: function () {
            setup("/actions/vurdere_klage_action_content");
        },
        ...
        "Test that vurder klage view shows right opprinnelig vedtatt beløp": function () {

            var model = new TestSoknadModel();

            var testVurderKlageView = new TestVurderKlageActionView({
                model: new ns.SoknadActionModel({'id': 'vurder_klage', 'soknad_id': model.id}),
                soknadModel: model
            });
