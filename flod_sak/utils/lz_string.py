...
class LZString:
    """
    Python implementasjon av lz-string for Javascript: http://pieroxy.net/blog/pages/lz-string/index.html
    basert på lz-string-python for python 3: https://github.com/eduardtomasek/lz-string-python
    """
